...
scoreboard players operation @e[name=editor,type=armor_stand,tag=relative_bound] xCoordinate -= @e[name=node,type=armor_stand,score_ID=1,score_ID_min=1,tag=trunk] xCoordinate
...
scoreboard players operation @e[name=editor,type=armor_stand,tag=relative_bound] yCoordinate -= @e[name=node,type=armor_stand,score_ID=1,score_ID_min=1,tag=trunk] yCoordinate
...
scoreboard players operation @e[name=editor,type=armor_stand,tag=relative_bound] zCoordinate -= @e[name=node,type=armor_stand,score_ID=1,score_ID_min=1,tag=trunk] zCoordinate
