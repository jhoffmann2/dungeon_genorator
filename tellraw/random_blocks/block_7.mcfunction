...
# Date:			5/22/18
# Version:		1.12
# Description:	launcher for the block update ui as block7
################################


scoreboard players tag @s add editBlock7

execute @S ~ ~ ~ function dungeon_genorator:block_placer/tags/inventorytest/clear_hotbar_slot_tags
scoreboard players tag @e[name=block7Memory] add copySlotTags
