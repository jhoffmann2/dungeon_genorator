...
# Date:			5/22/18
# Version:		1.12
# Description:	launcher for the block update ui as block5
################################


scoreboard players tag @s add editBlock5

execute @S ~ ~ ~ function block_placer:tags/inventorytest/clear_hotbar_slot_tags
scoreboard players tag @e[name=block5Memory] add copySlotTags
